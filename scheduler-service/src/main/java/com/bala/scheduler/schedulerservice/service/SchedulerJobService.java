package com.bala.scheduler.schedulerservice.service;
...
import com.bala.scheduler.schedulerservice.component.JobScheduleCreator;
import com.bala.scheduler.schedulerservice.entity.SchedulerJobInfo;
import com.bala.scheduler.schedulerservice.job.SimpleCronJob;
import com.bala.scheduler.schedulerservice.job.SimpleJob;
import com.bala.scheduler.schedulerservice.repository.SchedulerRepository;
...
public class SchedulerJobService {
	...
	Logger log = LoggerFactory.getLogger(SchedulerJobService.class);
	...
	private void scheduleNewJob(SchedulerJobInfo jobInfo) {
		try {
			...
			System.out.println("jobDetails key : "+jobDetail.getKey());
