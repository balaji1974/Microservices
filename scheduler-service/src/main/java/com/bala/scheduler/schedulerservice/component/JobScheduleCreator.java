package com.bala.scheduler.schedulerservice.component;
...
public class JobScheduleCreator {
	...
	Logger log = LoggerFactory.getLogger(JobScheduleCreator.class);
	
	// This is based on cron triggers
